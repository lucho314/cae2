    ...
    <div class="row" style="margin-top: 5px;">
        ...
        <div class="col-xs-12 col-md-5">
            ...
            <div class="input-group">
                <?= $f->field($form, "q")->input("search", ['class' => 'form-control', 'placeholder' => 'DNI o Nombre de Usuario','style' => "margin-top:-10px;"])->label(false) ?>
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-striped table-condensed">
                    ...
                    <tbody>
                        ...
                        <td><a href="<?= Url::toRoute(["usuario/view", "id" => $row['dni']]) ?>">Ver</a></td>
